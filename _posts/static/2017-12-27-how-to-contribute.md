...
Before submitting the issue please check the [issue tracker](https://github.com/flyve-mdm/windows-inventory-agent/issues), there exists the possibility that the bug was already reported by other contributor.
...
You can file new issues by filling out our [new issue form](https://github.com/flyve-mdm/windows-inventory-agent/issues/new).
...
* In GitHub, send a pull request to our [Repository](https://github.com/flyve-mdm/windows-inventory-agent).
...
Great! You can help us translating the project. We are currently translating to Korean, Spanish, French, Portuguese and Russian. See our [How to Translate](http://flyve.org/windows-inventory-agent/howtos/contribute-translating) guide to get started.